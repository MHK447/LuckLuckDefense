...
//        var tdlist = Tables.Instance.GetTable<PlanetWeaponInfo>().DataList.ToList();
...
//            SelectCountList.Add(tdlist[randvalue].weapon_idx);
...
//    {
//        GameRoot.Instance.UserData.CurMode.PlayerWeapon.CreateWeapon(weaponidx);
//        Hide();
//    }
